...
$idharga=$_GET['id'];
//query
$query_edit="SELECT * FROM `harga` where id_harga='$idharga'";
$data=mysqli_query($db,$query_edit);
$d=mysqli_fetch_array($data);
$id_harga=$d['id_harga'];
$tipe_bus=$d['tipe_bus'];
$harga_bus=$d['harga_bus'];
...
<body>
      ...
      <div class="container-fluid">
        ...
        <form method="post" action="transaksi.php">
          ...
          <div class="form-group">
            ...
            <input type="text" name="kelasTiket" class="form-control" value="<?php echo $tipe_bus?>" id="kelasTiket" readonly>
          </div>
          <!-- <div class="form-group">
            <label for="exampleFormControlInput1">Kelas Penumpang</label>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                ...
                <input type="text" name="hargaBus" class="form-control" id="hargaBus" value="<?php echo $harga_bus?>" readonly>
                  <!-- Rp. 0 -->
                <!-- </div> -->
            </div>
          </div>
    ...
    // const generateHargaTiket = (kelas) => {
      ...
      //   document.getElementById('hargaTiket').value = 'Rp. 200.000';
      // }

      // if (kelas.value == 'Eksekutif') {
      //   document.getElementById('hargaTiket').value = 'Rp. 250.000';
      // }

      // if (kelas.value == 'Bisnis') {
      //   document.getElementById('hargaTiket').value = 'Rp. 300.000';
      // }
    ...
    const generateTotalBayar = () => {
      ...
      hargaBus = Number(document.getElementById('hargaBus').value);
      ...
      totalBayar = (hargaBus * totalBukanLansia) + (hargaBus * 0.9 * totalLansia);
